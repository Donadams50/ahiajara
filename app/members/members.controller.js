...
exports.updateImage = async (req, res) => {
        ...
        if ( req.file){
            ...
            const updateImage = await Members.findOneAndUpdate({ _id }, { imgUrl: req.file.url });
    
              console.log(updateImage)
    
             res.status(200).send({message:"Image was  succesfully saved"})
            ...
            console.log(err)
            res.status(500).send({message:"Error while updating image "})
        }
